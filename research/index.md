...
| 4 — Generalisation | [phase-4-generalisation/](phase-4-generalisation/) | Phase 1 numerics + L²(γ)→L²(𝕋) functor | Blocked |
...
| Generalised algorithm write-up | [phase-4-generalisation/generalised-algorithm.md](phase-4-generalisation/generalised-algorithm.md) | Not started |
