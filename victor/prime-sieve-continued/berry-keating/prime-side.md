...
sieve ([prime-sieve.html](prime-sieve.html)) — plus classical literature cited in §9. Every
...
4. **Constructive skeleton (§6).** The sieve of [prime-sieve.html](prime-sieve.html) produces the
...
- **(C1) No normalisation.** The $1/\pi(M_n)$-normalised prime sums tend to zero uniformly
  ([prime-sieve.html](prime-sieve.html) §4, one-line Chebyshev estimate; also
...
- **(C2) Positions are flat; structure lives in the logarithms.** The normalised prime measure
  ...
  ([prime-sieve.html](prime-sieve.html) Theorem 3.1). Rescaled prime *positions* carry only
...
- **(C3) Constructivity.** The sieve enumerates the primes exactly, block by block
  ([prime-sieve.html](prime-sieve.html) Lemma 1.2), at the quantitative rate of its
...
[prime-sieve.html](prime-sieve.html) produces it stage by stage.
...
[prime-sieve.html](prime-sieve.html) Lemma 1.2; prime powers as powers of the listed primes). Let
...
[prime-sieve.html](prime-sieve.html), the dyadic block $I_n$ contributes
...
[prime-sieve.html](prime-sieve.html) says the *normalised positions* of the primes flatten to
...
[prime-sieve.html](prime-sieve.html):
...
- Companions: [prime-kernel.html](prime-kernel.html) (the three ingredients),
  [prime-sieve.html](prime-sieve.html) (sieve, equidistribution, no-normalisation estimate).
