# PSC2-S00 — the verified foundation (proven results compendium)

*Source document S00 of project PSC2 (see [../README.md](../README.md) for the numbering
convention). This is the dependency compendium of [../PSC2-000-charter.md](../PSC2-000-charter.md):
every proven result the charter's inventory builds on, reconstructed from first principles —
preliminaries, construction, statement, and proof — so the project can be read without leaving
this folder. Adapted verbatim from `prime-sieve-continued/references.md` (6 Jul 2026); in-text
pointers of the form `adele/…`, `berry-keating/…`, `prime-sieve/…`, `research-plan.md` are
archival provenance references to that snapshot, retained for audit; the mathematical content
here is complete without them. Tags follow [../PSC2-001-conventions.md](../PSC2-001-conventions.md).*
